  ...
  render() {
    return (
      <div className={classNames(this.props.className, 'Navigation')} role="navigation">
        ...
        <a className="Navigation-link" href="/client" onClick={Link.handleClick}>Client Area</a>
        <a className="Navigation-link" href="/vendor" onClick={Link.handleClick}>Vendor Area</a>
